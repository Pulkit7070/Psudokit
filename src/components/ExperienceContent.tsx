...
const experiences: ExperienceItem[] = [
  {
    ...
    points: [
      'Built a Banking MCP Server (Python, FastAPI, SQLite) exposing account management, deposits, withdrawals, and transaction history via both REST API and MCP protocol for AI assistant integration',
      'Redesigned armoriq.ai public landing page from the ground up as a single high-performance static build',
      'Ship features end-to-end: API design, backend logic, and UI, reporting directly to the VP of Engineering',
      'Operate autonomously in a fully remote team with production ownership from day one',
    ],
